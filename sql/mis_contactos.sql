/*-Los comentarion en sql con como en css*/
/*-SQL: Structure Query Language - Lenguaje Estructuado de Consulta 
-Base de datos: Colección de datos que están organizados
-En MySQL existen dos tipos de engine para tablas:
1) MyISAM - Tablas Planas (Como trabajar datos en Excel (Hojas de cálculo))
2)InnoDB - Tablas Relacionales (No se puede modificar un dato que afecte a otra tabla, 
    ya que hay una dependencia entre estas tablas)*/
...
)ENGINE=MyISAM DEFAULT CHARSET=latin1; /*ENGINE: Motor de búsqueda de MSQL*/
